...
In the ui.html file,
We can observe the **LIVE Working of Gradient Descent, an optimizer for Linear Regression.
\ It is trying to optimize values by minimizing mean squared error**.\
